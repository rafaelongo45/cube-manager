import { Container, Circle, CenterText, Reminder, ReminderText} from './styles';
...
export default function Reminders() {
  ...
  AsyncStorage.setItem('reminders', JSON.stringify([{name:"passear com cachorro", date:"28-09-2022"}]))
  ...
  return (
    <Container size={reminders.length} >
      ...
      { reminders.length ? reminders.map((reminder, index) => {
        return <Reminder key={index}><ReminderText>{reminder.name}</ReminderText></Reminder>
